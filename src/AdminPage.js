...
function AdminPanel() {
  ...
  const saveShow = useCallback(async (e) => {
    ...
    const { artista, data_inicio, data_fim, local, cidade, flyer } = formData;
...
function AdminPage() {
  ...
  useEffect(() => {
    // Verifica se já está logado (usando sessionStorage)
  ...
  const handleLogout = useCallback(() => {  
	...
	//Redirecionar IMEDIATAMENTE (sem mudar o state antes)  
